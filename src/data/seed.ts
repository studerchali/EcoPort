...
export const seedData: FinanceData = {
  ...
  expenses: [
    { id: 'exp-demo-1', date: '2026-05-28', category: 'Alimentación', detail: 'Compra semanal', amount: 85.4, currency: 'EUR', paymentMethod: 'Santander', notes: '' },
    ...
    { id: 'exp-demo-3', date: '2026-05-20', category: 'Vivienda', detail: 'Alquiler mayo', amount: 800, currency: 'EUR', paymentMethod: 'Santander', notes: '' },
    ...
    { id: 'exp-demo-6', date: '2026-05-05', category: 'Alimentación', detail: 'Delivery', amount: 22.5, currency: 'EUR', paymentMethod: 'Santander', notes: '' },
    { id: 'exp-demo-7', date: '2026-04-20', category: 'Vivienda', detail: 'Alquiler abril', amount: 800, currency: 'EUR', paymentMethod: 'Santander', notes: '' },
    { id: 'exp-demo-8', date: '2026-04-15', category: 'Alimentación', detail: 'Compra mensual', amount: 120, currency: 'EUR', paymentMethod: 'Santander', notes: '' },
  ],
  accountBalances: [
    { account: 'Efectivo', amount: 500, currency: 'EUR' },
    { account: 'Santander', amount: 3200, currency: 'EUR' },
  ],
  savedAccounts: ['Santander', 'Efectivo'],
  debts: [
